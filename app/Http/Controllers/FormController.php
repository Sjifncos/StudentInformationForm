<?php
    ...
    class FormController extends Controller
    {
        ...
        $validated = $request->validate([
            ...
            'degreeprogram' => 'required', //DROP DOWN
            ...
            // Foreign address (if citizenship = no)
            ...
            // Permanent address inside the Philippines
            ...
            // Guardian information (hidden by default, only shown conditionally)
            ...
            // ===== Academic Matters (step 6) – required only for undergraduates =====
            ...
            // ===== Education & Employment (step 7) – required only for graduates =====
            ...
            // ===== Additional Information (step 8) – always required =====
            ...
            // ===== Documents and Image Upload (Step 9) – always required =====
            'image'                         => 'required', // IMAGE
            'medical_certificate'           => 'required', //PDF
            'notice_of_admission'           => 'required', //PDF
            'honorable_dismissal'           => 'nullable', //PDF
            'tor_remarks'                   => 'required', //PDF
            'birth_certificate'             => 'required', //PDF
            'marriage_certificate'          => 'nullable', //PDF
            'pwd_card_container'            => 'required_if:pwd,yes', //IMAGE
            'marriage_container'            => 'nullable', //IMAGE

            // Step 10 UNDERTAKINGS 
            'confirmation' => 'required|accepted', // CHECKBOX
            'data_privacy' => 'required|accepted', //CHECKBOX
